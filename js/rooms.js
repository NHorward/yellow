...
function changeImageBedroom() {
	...
	if (parseFloat(sensorData[lastValue].RHBedroom) > 45 && parseFloat(sensorData[lastValue].RHBedroom) < 65) {}
	else {
		counter++;
	}
	if (parseFloat(sensorData[lastValue].CO2Bedroom) > 0 && parseFloat(sensorData[lastValue].CO2Bedroom) < 800) {}
	else {
		counter++;
	}
	if (counter >= 1) {
